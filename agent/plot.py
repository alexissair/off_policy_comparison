...
def parse_arguments():
    ...
    parser.add_argument('--epsilon', type=float, help='the initial value of the greediness factor (default: 0.2)')
    ...
    parser.add_argument('--gamma', type=float, help='the discount factor (default: 0.95)')
    parser.add_argument('--evaluate_every', type=int, help='the frequency where we evaluate the agent during training (default: 1000)')
    parser.add_argument('--episodes_to_evaluate', type=int, help='the number of episodes to use to evaluate the agent (default: 500)')
    parser.add_argument('--episodes_to_train', type=int, help='the number of episodes to train the agent (default: 30000)')
    parser.add_argument('--decay', type=bool, help='apply a decay to epsilon (default: True)')
